...
public class FileCheck {
    ...
    public void openXmlFile() throws PathNotFound {
    ...
    public void runAllChecks() throws JAXBException, WrongExtension, PathIsToShort, PathNotFound, MapBoundariesInvalid, NotUniqueName, StopBoundaries, NotUniqueLocation, PathAlreadyExists, InvalidRoute {
        checkPathName();
        openXmlFile();
        createTranspool();
        checkMapBoundaries();
