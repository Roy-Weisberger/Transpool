...
//    public double totalLength(Roads road) {
//        double sum=0;
//        String prev;
//        String curr=course.get(0);
//
//        for(int i=1;i<course.size();i++){
//           prev=curr;
//           curr=course.get(i);
//           road=road.
//           sum=StaticFunctions.class.getMethod(calculateGas())
//           sum = lengthBetweenRoads(curr,prev);
//          // sum = calculateGas(checkIfRoad)
//        }
//    }
